...
def analyze_news_tab():
    ...
    st.caption(
        "📂 Sample articles are randomly selected from the benchmark training dataset for demonstration purposes."
    )
    ...
    if analyze:
        ...
        This prediction is generated using a Machine Learning model trained on benchmark fake news datasets (ISOT & WELFake).

        Performance may vary for:
        - 📰 Breaking news
        - 🌍 Regional or local news
        - 🧠 Unseen topics outside the training data

        Always verify important information through trusted news sources before making decisions.
        """
        )
        ...
        A concise AI-generated summary after evaluating the article.
        ...
        <h4 style="margin-top:0;">🧠 Final Assessment</h4>
...
def about_tab():
    ...
    **B.Tech Artificial Intelligence & Machine Learning**
    ...
    - 📰 Trained on benchmark datasets (ISOT & WELFake).
    - 🌍 Performance may decrease on regional or unseen news topics.
    - ⚡ Breaking news may not be classified accurately.
    - 🤖 Predictions are probabilistic and should not be treated as absolute truth.
    - ✅ Always verify important information using trusted and official news sources.
    ...
    It is intended for educational, research and portfolio purposes.
...
📰 <b>AI Fake News Detection </b>

<br><br>

Built with using Python • Streamlit • Scikit-Learn • Plotly
